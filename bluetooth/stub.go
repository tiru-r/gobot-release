...
func (c *stubCentral) Scan(ctx context.Context, params ScanParams, callback func(Advertisement)) error {
	return nil
}
func (c *stubCentral) StopScan(ctx context.Context) error { return nil }
func (c *stubCentral) Connect(ctx context.Context, address Address, params ConnectionParams) (Device, error) {
